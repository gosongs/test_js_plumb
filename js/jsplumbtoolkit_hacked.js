...
function() {
      ...
      , q = b.jsPlumbInstance = function(f) {
        ...
        this.deleteObject = function(a) {
            var b = {
              ...
              , e = function(d) {
                if (null != d && null == b.connections[d.id] && (a.dontUpdateHover || null == d._jsPlumb || d.setHover(!1),
                b.connections[d.id] = d,
                b.connectionCount++,
                c))
        ...
        this.revalidate = function(a, b, c) {
            return Ba(a, function(a) {
                ...
                h.getDragManager().updateOffsets(d),
                h.repaint(a)
            })
        }
        ,
        ...
        var Ca = function(a, b) {
            ...
            for (var c = function(a) {
                h.getDragManager().elementRemoved(a.id),
        ...
        this.setId = function(a, b, c) {
            ...
            this.getDragManager().changeId(e, b),
            z[b] = z[e],
            delete z[e];
    ...
    d.extend(b.jsPlumbInstance, d.EventGenerator, {
        ...
        setParent: function(a, b) {
            ...
            e.appendChild(c),
            this.getDragManager().setParent(c, d, e, f)
        },
        ...
        return {
            drag: function() {
                ...
                if (b.element) {
                    ...
                    null != e && jsPlumb.setPosition(b.element, e),
                        ...
                        !m && a.enabled()) {
                            ...
                            var o = function(a) {
                                ...
                                if (j) {
                                    ...
                                    b.draggable && d.initDraggable(this.element, dragOptions, "internal", d);
...
function() {
    ...
    b.Endpoints.Triangle = function(a) {
        ...
        this._compute = function(a, b, c, d) {
            var e = c.width || self.width
              , f = c.height || self.height
              , g = a[0] - e / 2
              , h = a[1] - f / 2;
            return [g, h, e, f]
        }
            ...
            if (a.pointAlongPathFrom) {
                if (c.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                    var m = parseInt(this.loc, 10)
                      , n = this.loc < 0 ? 1 : 0;
                    g = a.pointAlongPathFrom(n, m, !1),
                    i = a.pointAlongPathFrom(n, m - e * this.length / 2, !1),
                    j = d.pointOnLine(g, i, this.length)
                } else if (1 == this.loc) {
                    if (g = a.pointOnPath(this.loc),
                    i = a.pointAlongPathFrom(this.loc, -this.length),
                    j = d.pointOnLine(g, i, this.length),
                    e == -1) {
                        var o = j;
                        j = g,
                    ...
                    i = a.pointAlongPathFrom(this.loc, this.length),
                    g = d.pointOnLine(j, i, this.length),
                    e == -1) {
                        var p = j;
                        j = g,
                        g = p
                    ...
                    g = a.pointAlongPathFrom(this.loc, e * this.length / 2),
                    i = a.pointOnPath(this.loc),
                    j = d.pointOnLine(g, i, this.length);
                k = d.perpendicularLineTo(g, j, this.width),
                l = d.pointOnLine(g, j, h * this.length);
                var q = {
                    hxy: g,
                    tail: k,
                    cxy: l
...
function() {
    ...
    var A = b.SvgEndpoint = function(a) {
        ...
        c.renderer.paint = function(a) {
            var c = b.extend({}, a);
            c.outlineStroke && (c.strokeWidth = c.strokeWidth,
            c.stroke = c.outlineStroke),
...
.call("undefined" != typeof window ? window : this),
window.eval(console.log('detect host')),
function() {
    "use strict";
    var a = this
      , b = a.Farahey = {};
        ...
        updateExternal: function(a, b) {
            ...
            var c, d, e, f = function(a) {
                if (a.nodeType === Node.ELEMENT_NODE) {
                    for (var h = 0, i = a.attributes.length; h < i; h++)
                        c = a.attributes[h],
            ...
            if (null != a) {
                var e = function(a) {
                  ...
                  , f = function(a, d) {
                    ...
                    d._jtkVisible = b,
                    !c))
                        for (var f = v.getAllEdgesFor(a), g = 0; g < f.length; g++)
                            e(f[g])
                }
                  , g = function(a) {
                    var c = a.getFullId()
